...
class Vern(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Vern client instance.

        This automatically infers the `api_key` argument from the `VERN_SDK_API_KEY` environment variable if it is not provided.
        """
        if api_key is None:
            api_key = os.environ.get("VERN_SDK_API_KEY")
        if api_key is None:
            raise VernError(
                "The api_key client option must be set either by passing api_key to the client or by setting the VERN_SDK_API_KEY environment variable"
            )
...
class AsyncVern(AsyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncVern client instance.
